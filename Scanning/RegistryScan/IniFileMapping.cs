...
{
    public class IniFileMapping
    {
        private static readonly string RegistryPath = @"SOFTWARE\Microsoft\Windows NT\CurrentVersion\IniFileMapping";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\IniFileMapping", "SYSTEM.INI", "@SYS: SYSTEM.INI"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\IniFileMapping", "Winlogon", "@SYS: Malicious.ini"),
        };

        public static void ScanIniFileMapping()
        {
            Console.WriteLine("Starting scan for IniFileMapping...");
