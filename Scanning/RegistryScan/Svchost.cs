...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    ...
    {
        private static readonly string RegistryPath = @"SOFTWARE\Microsoft\Windows NT\CurrentVersion\Svchost";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Svchost", "netsvcs", "TrustedService"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Svchost", "netsvcs", "MaliciousService"),
        };

        public static void ScanSvchost()
        {
