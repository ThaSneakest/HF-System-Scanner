...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class MpsSvc
    {
        private static readonly string RegistryPath = @"SYSTEM\CurrentControlSet\Services\MpsSvc";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MpsSvc", "Start", "2"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MpsSvc", "Type", "32"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MpsSvc", "Start", "4"), // Disabled Service
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MpsSvc", "ImagePath", @"C:\Malicious\malware.exe"),
        };

        public static void ScanMpsSvc()
        {
            Console.WriteLine("Starting scan for MpsSvc registry key...");
