...
{
    public class ShellServiceObjects
    {
        private static readonly string[] RegistryPaths =
  {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\ShellServiceObjects", "SafeObject", ""),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\ShellServiceObjects", "MaliciousObject", ""),
        };

        public static void ScanShellServiceObjects()
        {
            Console.WriteLine($"Starting scan for ShellServiceObjects registry keys...");
