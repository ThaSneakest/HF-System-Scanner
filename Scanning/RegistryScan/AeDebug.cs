...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class AeDebug
    {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Microsoft\Windows NT\CurrentVersion\AeDebug", "Auto", "1"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Microsoft\Windows NT\CurrentVersion\AeDebug", "Debugger", "drwtsn32 -p %ld -e %ld -g"),
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Microsoft\Windows NT\CurrentVersion\AeDebug", "Debugger", "malicious.exe"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Microsoft\Windows NT\CurrentVersion\AeDebug", "Test", @"C:\wildlands\test.dll"),
            // Add more blacklist entries as needed
        };

        public static void ScanAeDebug()
        {
            string registryPath = @"Software\Microsoft\Windows NT\CurrentVersion\AeDebug";
