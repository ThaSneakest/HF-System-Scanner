...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class Hivelist
    {
        ...
        private static readonly string RegistryPath = @"SYSTEM\CurrentControlSet\Control\hivelist";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\hivelist", "SystemRoot", @"\Registry\Machine\SYSTEM"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\hivelist", "Software", @"\Registry\Machine\SOFTWARE"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\hivelist", "MaliciousHive", @"\Registry\Machine\MALICIOUS"),
        };

        public static void ScanHiveList()
        {
            Console.WriteLine("Starting scan for Hivelist registry path...");
