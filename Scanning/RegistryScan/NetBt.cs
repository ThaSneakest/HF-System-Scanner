...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class NetBt
    {
        private static readonly string RegistryPath = @"SYSTEM\CurrentControlSet\Services\NetBT";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NetBT", "Start", "2"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NetBT", "Type", "1"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NetBT", "Start", "4"), // Disabled Service
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\NetBT", "ImagePath", @"C:\Malicious\malware.exe"),
        };

        public static void ScanNetBT()
        {
            Console.WriteLine("Starting scan for NetBT registry key...");
