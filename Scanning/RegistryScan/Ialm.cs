...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class Ialm
    {
        private static readonly string RegistryPath = @"System\CurrentControlSet\Services\ialm";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\ialm", "Start", "1"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\ialm", "Type", "1"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\ialm", "Start", "4"), // Disabled ialm service
            Tuple.Create(@"HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\ialm", "ImagePath", @"C:\Malicious\ialm.sys"), // Malicious driver
        };

        public static void ScanIalm()
        {
            Console.WriteLine("Starting scan for ialm registry path...");
