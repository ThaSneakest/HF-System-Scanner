...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class BootVerification
    {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\BootVerificationProgram", "SafeEntry", "Valid"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\BootVerificationProgram\ImagePath", "", "C:\\Windows\\System32\\winlogon.exe"),
            // Add additional whitelist values as needed
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\BootVerificationProgram", "MaliciousEntry", "Unknown"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\BootVerificationProgram\ImagePath", "", "C:\\Malicious\\hacker.exe"),
            // Add more suspicious values as needed
        };

        public static void ScanBootVerificationProgram()
        {
