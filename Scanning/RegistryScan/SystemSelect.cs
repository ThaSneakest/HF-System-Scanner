...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    ...
    {
        private static readonly string RegistryPath = @"System\Select";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\Select", "Current", "1"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\Select", "Current", "9999"), // Example of a suspicious value
        };

        public static void ScanSystemSelect()
        {
