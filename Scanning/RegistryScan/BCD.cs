...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class BCD
    {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\BCD00000000", "ExampleSafeValue", "SafeData"),
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\BCD00000000", "MaliciousEntry", "Malware"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\BCD00000000", "SuspiciousPath", "C:\\Malicious\\HackTool"),
            // Add more suspicious values as needed
        };

        public static void ScanBCDRegistry()
        {
            string registryPath = @"BCD00000000";
