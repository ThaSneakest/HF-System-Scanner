...
{
    public class ShellIconOverlayIdentifiers
    {
        private static readonly string[] RegistryPaths =
  {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\ShellIconOverlayIdentifiers", "OneDrive1", ""),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\ShellIconOverlayIdentifiers", "MaliciousOverlay", ""),
        };

        public static void ScanShellIconOverlay()
        {
            Console.WriteLine($"Starting scan for ShellIconOverlayIdentifiers registry keys...");
