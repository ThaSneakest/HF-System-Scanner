...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class Tcpip
    {
        private static readonly string RegistryPath = @"SYSTEM\CurrentControlSet\Services\Tcpip\Parameters";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters", "DhcpDomain", "example.com"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters", "EnableDHCP", "1"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters", "EnableProxy", "1"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters", "NameServer", "8.8.8.8"),
        };

        public static void ScanTcpIpParameters()
        {
