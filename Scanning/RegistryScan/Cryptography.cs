...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class Cryptography
    {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Cryptography\OID\EncodingType 0\CryptSIPDllGetSignedDataMsg", "DefaultValue", "SafeData"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Cryptography\OID\EncodingType 0\CryptSIPDllGetSignedDataMsg", "MaliciousEntry", "MaliciousData"),
        };

        public static void ScanCryptographyRegistry()
        {
            string registryPath = @"SOFTWARE\WOW6432Node\Microsoft\Cryptography\OID\EncodingType 0\CryptSIPDllGetSignedDataMsg";
