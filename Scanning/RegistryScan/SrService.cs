...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    ...
    {
        private static readonly string RegistryPath = @"SYSTEM\CurrentControlSet\Services\srservice";
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\srservice", "SafeValue", "AllowedData"),
        };
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\srservice", "MaliciousValue", "ThreatData"),
        };

        public static void ScanSrService()
        {
            Console.WriteLine($"Starting scan for srservice registry keys...");
