...
namespace Wildlands_System_Scanner.Scanning.RegistryScan
{
    public class BITS
    {
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\BITS", "SafePolicy", "Enabled"),
        ...
        {
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\BITS", "MaliciousPolicy", "Disable"),
            Tuple.Create(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\BITS", "SuspiciousSetting", "Unknown"),
            // Add more suspicious values as needed
        };

        public static void ScanBITSKey()
        {
            string registryPath = @"Software\Policies\Microsoft\Windows\BITS";
