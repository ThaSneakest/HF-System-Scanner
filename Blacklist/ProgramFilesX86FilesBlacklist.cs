...
{
    public class ProgramFilesX86FileBlacklist
    {
        public static void ScanForBlacklistedFiles()
        {
            // Predefined blacklist of file names in Program Files (x86) (case insensitive)
...
"Words fly at you.lnk",
            ...
            // Predefined whitelist of directories to exclude from scanning
            HashSet<string> excludedDirectories = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
            {
@"C:\Program Files (x86)\Android\openjdk\jdk-17.0.12\bin\java.exe",
@"C:\Program Files (x86)\Android\openjdk\jdk-17.0.12\bin\javaw.exe",
@"C:\Program Files (x86)\Internet Explorer\iexplore.exe",

            };

            string programFilesX86Path = @"C:\Program Files (x86)\";
            Console.WriteLine($"Scanning files in {programFilesX86Path}...");
            ...
            try
            {
                ...
                // Get all files in Program Files (x86) directory and subdirectories
                string[] files = Directory.GetFiles(programFilesX86Path, "*.*", SearchOption.AllDirectories);
